...
@section('content')
        ...
        <div class="container">
            <div class="archive-header">
                <div class="row align-items-center">
                    <div class="col-xl-3 category-header">
    ...
    <div class="container mb-30">
        <div class="row flex-row-reverse">
            <div class="col-lg-4-5 content-product">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a class="quick-view-btn" data-bs-toggle="modal" data-bs-target="#quickViewModal"
                                            data-id={{ $product->id }}>
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <h2><a class="quick-view-btn" data-bs-toggle="modal" data-bs-target="#quickViewModal"
                        ...
                        @foreach ($categories as $category)
                            <li>
                                <button class="fetchProductByCategory-btn"
                                    ...
                                    <img style="width:30px" src="{{ asset($category->image) }}" alt="" />
                                    {{ $category->name }}
                                    <span class="count-2"
                                        style="margin-left: auto;">{{ $category->products->count() }}</span>
