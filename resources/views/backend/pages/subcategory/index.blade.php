...
@section('content')
    ...
    {{-- Edit Modal --}}
    @include('backend.pages.subcategory.partials.edit-modal')

    {{-- Create Modal --}}
    @include('backend.pages.subcategory.partials.create-modal')
@endsection


@push('scripts')
    {{ $dataTable->scripts(attributes: ['type' => 'module']) }}
    <script src="{{ asset('assets/js/backend/subcategory.js') }}"></script>
@endpush
